...
public class Field extends JFrame implements ActionListener {
	...
	public Field(Hero firstHero, Hero secondHero){
		...
		oppHand = new ImagePanel(new ImageIcon("Graphics/Back.png").getImage());
		oppHand.setBackground(Color.white);
		...
		oppField = new ImagePanel(new ImageIcon("Graphics/FieldMain.png").getImage());
		oppField.setBackground(Color.yellow);
		...
		currField = new ImagePanel(new ImageIcon("Graphics/FieldMain.png").getImage());
		currField.setBackground(Color.cyan);
		...
		currHand = new ImagePanel(new ImageIcon("Graphics/Back.png").getImage());
		currHand.setBackground(Color.white);
